...
Route::delete('/entradas/{entrada}', [EntradaController::class, 'destroy'])->middleware(['auth'])->name('entradas.destroy');
...
Route::delete('/salidas/{salida}', [SalidaController::class, 'destroy'])->middleware(['auth'])->name('salidas.destroy');

// Rutas para el Balance y PDF (Ahora protegidas)
Route::get('/balance', [ReporteBalanceController::class, 'index'])->middleware(['auth'])->name('balance.index');
Route::get('/balance/pdf', [ReporteBalanceController::class, 'exportPdf'])->middleware(['auth'])->name('balance.pdf');
